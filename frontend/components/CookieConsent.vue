<template>
  <div v-if="showBanner" class="fixed bottom-0 left-0 right-0 bg-[#f6f5eee0]  text-gray-800 p-4 shadow-lg z-50">
    <div class="max-w-7xl mx-auto flex flex-col items-center text-center gap-4">
      <div>
        ...
        <p class="text-lg text-gray-700">
          We use cookies to enhance your experience and analyze website traffic. This includes Google Analytics to help us understand how visitors use our site.
          <NuxtLink to="/docs/Cookies" class="underline text-primary hover:text-secondary">
