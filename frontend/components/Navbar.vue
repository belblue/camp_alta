    ...
    <div  class="nav fixed top-0 z-2000 w-full" :class="headerClass">
        <div class=" py-2 px-4 flex mt-1 mx-2 flex-row " :class="bgClass" ><!-- data-aos="fade" data-aos-delay="750" class="bg-white top-0 w-full z-10 shadow-md py-1 px-4 absolute flex flex-row items-center justify-between "-->
            ...
            <div class="ml-28 pt-1 mr-auto hidden lg:block">
                <NuxtLink class="pr-8 py-1.5 text-xl ml-2.5 line-link font-bold"  to="/TheCamp"> The Camp </NuxtLink> 
                <NuxtLink class="pr-8 py-1.5 text-xl ml-2.5  line-link font-bold" to="/Cabins">Cabins</NuxtLink> 
                <NuxtLink class="pr-8 py-1.5 text-xl ml-2.5  line-link font-bold" to="/Tours">Tours</NuxtLink> 
                <NuxtLink class="pr-8 py-1.5 text-xl ml-2.5 text-[#04b684] line-link font-bold" to="/LakesideAuroraCabins">Lakeside Aurora Cabins</NuxtLink>
                <NuxtLink class="pr-8 py-1.5 text-xl ml-2.5  line-link font-bold" to="/Prices">Prices</NuxtLink> 
                <NuxtLink class="pr-8 py-1.5 text-xl ml-2.5  line-link font-bold" to="/FaQ">FAQ</NuxtLink>
                <NuxtLink class="pr-8 py-1.5 text-xl ml-2.5  line-link font-bold" to="/#Contact">Contact</NuxtLink>  
            </div>
            <!--<LangSwitcher/>-->
            <div class="hidden md:block lg:hidden mx-auto mt-2">
                <NuxtLink class="btn bg-secondary w-20" to="/Booking">Book here</NuxtLink>           
            </div>
            <div class="flex md:ml-0 ml-auto">
                ...
                <NuxtLink class="btn bg-primary text-white font-bold hidden lg:block" to="/Booking">
        ...
        <div v-if="open==true" class="absolute top-12 grid w-full z-10 text-center  drop-shadow-xl pt-4">
            <NuxtLink class="p-2.5 hover:bg-bg2 text-xl bg-white mx-2 -mt-1" to="/TheCamp">The Camp</NuxtLink>
            <NuxtLink class="p-2.5 hover:bg-bg2 text-xl bg-white mx-2 -mt-1" to="/Cabins">Cabins</NuxtLink>
            <NuxtLink class="p-2.5 hover:bg-bg2 text-xl bg-white mx-2 -mt-1" to="/Tours">Tours</NuxtLink>
            <NuxtLink class="p-2.5 hover:bg-bg2 text-xl bg-white mx-2 -mt-1 text-[#04b684]" to="/LakesideAuroraCabins">Lakeside Aurora Cabins</NuxtLink>
            <NuxtLink class="p-2.5 hover:bg-bg2 text-xl bg-white mx-2 -mt-1" to="/Prices">Prices</NuxtLink>
            <NuxtLink class="p-2.5 hover:bg-bg2 text-xl bg-white mx-2 -mt-1" to="/FAQ">FAQ</NuxtLink>
            <NuxtLink class="p-2.5 hover:bg-bg2 text-xl bg-white mx-2 -mt-1" to="/#Contact">Contact</NuxtLink>
            <span class="md:hidden bg-white p-2.5 mx-2"><NuxtLink class="btn bg-primary  mx-4 " to="/Booking">Book here</NuxtLink></span>
        </div>
    </div>
</template>
